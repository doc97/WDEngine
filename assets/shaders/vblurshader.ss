...
void main()
{
    ...
    v_blurTexCoords[ 3] = v_texCoord + vec2(0.0, -0.016 * blurFactor);
    v_blurTexCoords[ 4] = v_texCoord + vec2(0.0, -0.012 * blurFactor);
    v_blurTexCoords[ 5] = v_texCoord + vec2(0.0, -0.008 * blurFactor);
    v_blurTexCoords[ 6] = v_texCoord + vec2(0.0, -0.004 * blurFactor);
    v_blurTexCoords[ 7] = v_texCoord + vec2(0.0,  0.004 * blurFactor);
    v_blurTexCoords[ 8] = v_texCoord + vec2(0.0,  0.008 * blurFactor);
    v_blurTexCoords[ 9] = v_texCoord + vec2(0.0,  0.012 * blurFactor);
    v_blurTexCoords[10] = v_texCoord + vec2(0.0,  0.016 * blurFactor);
